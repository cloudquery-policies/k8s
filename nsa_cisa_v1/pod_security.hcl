...
policy "pod_security" {
  ...
  doc = file("nsa_cisa_v1/docs/pod_security/pod_security.md")

  check "container_disallow_host_path" {
    title = "Disallow host path access"
    doc = file("nsa_cisa_v1/docs/pod_security/container_disallow_host_path.md")
  ...
  policy "container_privilege_escalation_disabled" {
    title ="Container privileged escalation disabled"
      doc = file("nsa_cisa_v1/docs/pod_security/allow_privileged_access_disabled.md")
  ...
  policy "host_network_access_disabled" {
    ...
    doc = file("nsa_cisa_v1/docs/pod_security/host_network_access_disabled.md")
  ...
  policy "hostpid_hostipc_sharing_disabled" {
    ...
    doc = file("nsa_cisa_v1/docs/pod_security/host_pid_ipc_disabled.md")
  ...
  policy "immutable_container_filesystem" {
      ...
      doc = file("nsa_cisa_v1/docs/pod_security/read_only_root_filesystem.md")
  ...
  policy "non_root_container" {
    ...
    doc = file("nsa_cisa_v1/docs/pod_security/non_root_containers.md")
  ...
  policy "service_account_token_disabled" {
    ...
    doc = file("nsa_cisa_v1/docs/pod_security/service_account_token_disabled.md")
